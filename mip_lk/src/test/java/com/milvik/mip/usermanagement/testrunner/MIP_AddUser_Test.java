...
public class MIP_AddUser_Test {
	...
	public void addUserOne(String fname, String sname, String mobilenum,
			...
			String succmsg) throws Throwable {
		try {
			...
			Assert.assertTrue(adduserpage.supervisor_yes.isDisplayed());
			Assert.assertTrue(adduserpage.supervisor_no.isDisplayed());
			...
			Assert.assertTrue(!adduserpage.supervisor_no.isSelected());
			Assert.assertTrue(!adduserpage.supervisor_yes.isSelected());
		} catch (Throwable t) {
			homepage.clickOnMenu(MIP_Menu_Constants.ADD_USER);
	...
	public void addUserPassThree(String testcase, String fname, String sname,
			...
			String supervisorname, String errmsg) throws Throwable {
		try {
			...
			adduserpage = PageFactory.initElements(
					MIP_Test_Configuration.driver, MIP_AddUserPage.class);
			adduserpage.enterUserInfo(fname, sname, mobilenum, email, dob,
					gender, role.trim(), branch.trim(), is_supervisor, supervisorname)
					.clickOnSave();
